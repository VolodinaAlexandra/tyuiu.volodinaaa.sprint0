// tyuiu.volodinaaa.sprint0.task6.v2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    float b;
    std::cin >> b;
    std::cout << "x*y/(5+x)+6 =  " << service->Calculate(a, b);
    std::cout << std::endl;
}
